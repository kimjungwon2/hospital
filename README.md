...
>병원 정보, 위치(지도), 리뷰, Q&A 등의 기능이 있는 웹사이트. [경기데이터드림](https://data.gg.go.kr/portal/mainPage.do)의 DB를 활용하여 300개 이상의 DB를 삽입했다.

<br>

- **사용 방법**: 검색 창에 '**내과**'를 치시면, 병원 목록들을 볼 수 있습니다. '**센텀**'으로 검색하시면 병원 관리자가 등록된 병원을 볼 수 있다. 병원 관리자가 등록된 병원은 상세 정보와 Q&A 정보들을 볼 수 있다. 
- **병원 관리자(엘병원) 계정**: ID = manager53@naver.com. PW = aoslwj5. </br>
- **관리자 계정**: 악용을 방지하기 위해서 공유하지 않겠습니다.</br>

## 1. 프로젝트 요약 
![image](https://github.com/kimjungwon2/hospital/assets/40010165/ca74da6c-582b-4065-a17f-914448a55acc)
</br>
