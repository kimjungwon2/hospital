...
public class DoctorApiController {
    ...
    public CreateDoctorResponse staffSaveDoctor(ServletRequest servletRequest, @RequestBody @Validated StaffCreateDoctorRequest request){
    ...
    public void staffDeleteDoctor(ServletRequest servletRequest,@PathVariable("memberId") Long memberId, @PathVariable("doctorId") Long doctorId){
