...
public class ReviewService {
    ...
    public Long reviewRegister(Long memberId, Long hospitalId, ReviewHospital reviewHospitalDTO) {
        ...
        ReviewHospital reviewHospital = ReviewHospital
                .saveReviewHospital(hospital, reviewHospitalDTO);
    ...
    //병원 관계자 리뷰 검색
    public Page<Review> staffSearchReviews(ServletRequest servletRequest,
            StaffReviewSearchCondition condition, Pageable pageable) {
